...
<html lang="en">
    ...
    <div class="row">
      ...
      <div class="col" style="background-color:white;"><span style="color:orange;"><h1 class="display-4">2</h1></span></div>
...
// FIN ELEGIR AL AZAR
  ...
  print '<table width="50%" border="0">';
	...
	print '<div class="card-deck">';
			...
			?>
  <form id="resultado" name="resultado" action="guarda_resultados2.php" method="POST">
			<tr><td>
            <div class="card">
              <div class="card-body">
