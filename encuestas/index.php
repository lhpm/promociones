...
<div class="container">
	...
	<div class="row">
	<h2 class='text-center text-success'>Encuestas</h2>
	<div class="col-lg-2">
		
	</div>
	<div class="col-lg-12">
	    <a href="nuevo.php">Nueva encuesta</a>
		<p></p>
		...
		<?php
			...
			?>
				<tr>
					...
					<td><?php echo $crow['nroencuesta']; ?></td>
					<td><?php echo $crow['pregunta']; ?></td>
					<td><?php echo $crow['cliente']; ?></td>
					<td><?php echo $crow['prioridad']; ?></td>
					<td><?php echo $crow['encuesta']; ?></td>
					<td style="vertical-align:middle;">
					<a href="agregar_respuestas.php?id=<?php echo $crow['id'];?>&pregunta=<?php echo $crow['pregunta'];?>&nroencuesta=<?php echo $crow['nroencuesta'];?>"><span class="glyphicon glyphicon-plus"></span></a>
				    <a href="ver_respuestas.php?id=<?php echo $crow['id'];?>"><span class="glyphicon glyphicon-open"></span></a>
					</td>
					<td style="vertical-align:middle;">
